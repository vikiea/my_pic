...
2. [序列化](#序列化)
3. proto教程
   1. [proto3的改变](#proto3的改变)
   2. [一个简单的例子](#一个简单的例子)
   3. [proto3 格式](#proto3_格式)
   4. [版本定义](#版本定义)
   5. [引入其它proto文件](#引入其它proto文件)
   6. [package](#package)
   7. [option](#option)
   8. [普通字段](#普通字段)
   9. [Oneof](#Oneof)
...
[![img](normal-types.png)](normal-types.png)

编译成Go文件：`protoc -I=. -I/usr/local/include -I=$(GOPATH)/src --go_out=. types.proto`。
[![img](normal-types-in-go.png)](normal-types-in-go.png)
...
[![img](wire-type.png)](https://colobu.com/2019/10/03/protobuf-ultimate-tutorial-in-go/wire-type.png)
...
![img](https://gitee.com/vikieq/my_pic/raw/master/uPic/2021%2012%20022DuHpYUbc51vZQG.png)

第一个字段的类型是字符串(wire type是2), 字段编号是1 (00000001)， 字段编号左移三位再加上wiretype就是`0a`(00001010)。
![img](https://gitee.com/vikieq/my_pic/raw/master/uPic/2021%2012%2002field1.png)

第二个字段的类型是int32(wire type是0), 字段编号是2 (00000010)， 字段编号左移三位再加上wiretype就是`10`(00010000)。
![img](https://gitee.com/vikieq/my_pic/raw/master/uPic/2021%2012%2002field2.png)

第三个字段的类型是字符串(wire type是2), 字段编号是3 (00000011)， 字段编号左移三位再加上wiretype就是`1a`(00011010)。
![img](https://gitee.com/vikieq/my_pic/raw/master/uPic/2021%2012%2002field3.png)
